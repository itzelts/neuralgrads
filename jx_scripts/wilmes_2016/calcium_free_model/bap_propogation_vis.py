...
G_SOMA_AMPA = 0.007 # uS = 7 nS — threshold excitation
SOMA_EXC_LOC = 0.5
...
os.makedirs("results/calcium_free_model/", exist_ok=True)
...
if __name__ == "__main__":
    out_path = os.path.join("results", "calcium_free_model", "bap_propagation_time.png")
    paths = build_paths()
