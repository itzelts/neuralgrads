...
os.makedirs("results/calcium_free_model/soma_ampa_sweep", exist_ok=True)
...
fig.tight_layout()
fig.savefig("results/calcium_free_model/soma_ampa_sweep/soma_traces_regimes.png", dpi=150, bbox_inches="tight")
