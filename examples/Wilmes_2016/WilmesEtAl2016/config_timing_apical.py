...
"""config-file for Figure 3C"""

# _title_     : config_timing_apical.py
...
#   'Synapse':
#       {
#        'pos': ParameterArray([1]), #1,3
#        'shunt_pos': ParameterArray([2]), #0,1,2
#        'shunt_weight':ParameterArray(np.arange(0.0,0.1,0.01)),
#        'shunt_delay':ParameterArray(np.arange(-5,5,0.1)),
...
params = {
    ...
    'shunt':
        {
        'delay_start':Parameter(-5),
        'delay_end':Parameter(5),
