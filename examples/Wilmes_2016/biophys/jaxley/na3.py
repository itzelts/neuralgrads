...
class na3(Channel):
    ...
    def set_tadj(self, temperature):
        ...
        q10 = self.channel_params.get(f"q10_na3")
        reference_temp = self.channel_params.get(f"temp_na3")
    ...
    def alpv(self, v):
        vvh = self.channel_params.get("vvh_na3", 1)
        vvs = self.channel_params.get("vvs_na3", 1)
    ...
    def alps(self, v):
        vhalfs = self.channel_params.get("vhalfs_na3", 1)
        zetas = self.channel_params.get("zetas_na3", 1)
    ...
    def bets(self, v):
        vhalfs = self.channel_params.get("vhalfs_na3", 1)
        zetas = self.channel_params.get("zetas_na3", 1)
        gms = self.channel_params.get("gms_na3", 1)
    ...
    def compute_kinetic_variables(self, v):
        tha = self.channel_params.get("tha_na3", 1)
        qa = self.channel_params.get("qa_na3", 1)
        Ra = self.channel_params.get("Ra_na3", 1)
        Rb = self.channel_params.get("Rb_na3", 1)
        thi1 = self.channel_params.get("thi1_na3", 1)
        thi2 = self.channel_params.get("thi2_na3", 1)
        qd = self.channel_params.get("qd_na3", 1)
        qg = self.channel_params.get("qg_na3", 1)
        mmin = self.channel_params.get("mmin_na3", 1)
        hmin = self.channel_params.get("hmin_na3", 1)
        q10 = self.channel_params.get("q10_na3", 1)
        Rg = self.channel_params.get("Rg_na3", 1)
        Rd = self.channel_params.get("Rd_na3", 1)
        thinf = self.channel_params.get("thinf_na3", 1)
        qinf = self.channel_params.get("qinf_na3", 1)
        a0s = self.channel_params.get("a0s_na3", 1)
        smax = self.channel_params.get("smax_na3", 1)
        ar2 = self.channel_params.get("ar2_na3", 1)
