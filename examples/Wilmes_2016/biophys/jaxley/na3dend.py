...
class na3dend(Channel):
    """
    na3
    """

    def __init__(self, name="na3dend"):
    ...
    def set_tadj(self, temperature):
        ...
        q10 = self.channel_params.get(f"q10_na3dend")
        reference_temp = self.channel_params.get(f"temp_na3dend")
    ...
    def alpv(self, v):
        vvh = self.channel_params.get("vvh_na3dend", 1)
        vvs = self.channel_params.get("vvs_na3dend", 1)
    ...
    def alps(self, v):
        vhalfs = self.channel_params.get("vhalfs_na3dend", 1)
        zetas = self.channel_params.get("zetas_na3dend", 1)
    ...
    def bets(self, v):
        vhalfs = self.channel_params.get("vhalfs_na3dend", 1)
        zetas = self.channel_params.get("zetas_na3dend", 1)
        gms = self.channel_params.get("gms_na3dend", 1)
    ...
    def compute_kinetic_variables(self, v):
        ...
        Rb = self.channel_params.get("Rb_na3dend", 1)
        thi1 = self.channel_params.get("thi1_na3dend", 1)
        thi2 = self.channel_params.get("thi2_na3dend", 1)
        qd = self.channel_params.get("qd_na3dend", 1)
        qg = self.channel_params.get("qg_na3dend", 1)
        mmin = self.channel_params.get("mmin_na3dend", 1)
        hmin = self.channel_params.get("hmin_na3dend", 1)
        q10 = self.channel_params.get("q10_na3dend", 1)
        Rg = self.channel_params.get("Rg_na3dend", 1)
        Rd = self.channel_params.get("Rd_na3dend", 1)
        thinf = self.channel_params.get("thinf_na3dend", 1)
        qinf = self.channel_params.get("qinf_na3dend", 1)
        a0s = self.channel_params.get("a0s_na3dend", 1)
        smax = self.channel_params.get("smax_na3dend", 1)
        ar2 = self.channel_params.get("ar2_na3dend", 1)
